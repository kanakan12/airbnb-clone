...
#         form = forms.LoginForm(initial={"email": "wls@gus.com"})
...
class UpdatePasswordView(mixins.EmialLoginOnlyView, mixins.LoggedInOnlyView, SuccessMessageMixin, PasswordChangeView):
    ...
    def get_form(self, form_class=None):
        ...
        form.fields["new_password2"].widget.attrs = {"placeholder": "Comfirm New Password"}
        return form
